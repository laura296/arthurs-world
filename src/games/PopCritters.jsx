...
export default function PopCritters() {
  ...
  return (
    <div className="relative w-full h-full overflow-hidden">
      ...
      {/* Score badge */}
      <div className="fixed top-4 right-4 z-50 bg-amber-900/40 backdrop-blur-sm rounded-full px-5 py-2
                      text-2xl font-heading text-sun border-2 border-amber-600/30 shadow-lg">
        {score}
      </div>
