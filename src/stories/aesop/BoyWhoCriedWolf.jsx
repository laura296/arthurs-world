...
const storyData = {
  ...
  pages: [
    // ── Page 1: The Shepherd Boy ──
    {
      ...
      interactions: [
        { id: 'boy-sound', type: 'character-speak', targetId: 'boy', data: { say: 'What a boring day!', character: 'boy' } },
        { id: 'sheep1-sound', type: 'tap-sound', targetId: 'sheep1', data: { say: 'Baa!', sfx: 'sheep' } },
    ...
    // ── Page 2: Boy Gets Bored ──
    {
      ...
      interactions: [
        { id: 'boy-shout-sound', type: 'character-speak', targetId: 'boy-shout', data: { say: 'WOLF! WOLF!', character: 'boy' } },
    ...
    // ── Page 3: Villagers Come ──
    {
      ...
      interactions: [
        { id: 'villager1-sound', type: 'character-speak', targetId: 'villager1', data: { say: 'Where is the wolf?', character: 'villager' } },
        { id: 'villager2-shake', type: 'tap-shake', targetId: 'villager2', data: {} },
        { id: 'villager3-wiggle', type: 'tap-wiggle', targetId: 'villager3', data: {} },
        { id: 'boy-laugh-sound', type: 'character-speak', targetId: 'boy-laugh', data: { say: 'Ha ha! I tricked you!', character: 'boy' } },
      ],
    },
    ...
    // ── Page 4: Second Time ──
    {
      ...
      interactions: [
        { id: 'boy-shout2', type: 'character-speak', targetId: 'boy-again', data: { say: 'WOLF! WOLF! Come quick!', character: 'boy' } },
    ...
    // ── Page 5: Villagers Angry ──
    {
      ...
      interactions: [
        { id: 'villager1-sound', type: 'character-speak', targetId: 'angry-villager1', data: { say: 'You tricked us again!', character: 'villager' } },
        { id: 'villager2-shake', type: 'tap-shake', targetId: 'angry-villager2', data: {} },
        { id: 'boy-giggle-sound', type: 'character-speak', targetId: 'boy-giggle', data: { say: 'Hee hee!', character: 'boy' } },
    ...
    // ── Page 6: Real Wolf Comes ──
    {
      ...
      interactions: [
        { id: 'wolf-sound', type: 'character-speak', targetId: 'real-wolf', data: { say: 'Grrrrr!', character: 'wolf' } },
        { id: 'wolf-shake', type: 'tap-shake', targetId: 'real-wolf', data: {} },
        { id: 'boy-sound', type: 'character-speak', targetId: 'boy-scared', data: { say: 'WOLF! REAL WOLF!', character: 'boy' } },
    ...
    // ── Page 7: Nobody Comes ──
    {
      ...
      interactions: [
        { id: 'boy-cry', type: 'character-speak', targetId: 'boy-alone', data: { say: 'Please help! This time it is real!', character: 'boy' } },
    ...
    // ── Page 8: The Lesson ──
    {
      ...
      interactions: [
        { id: 'farmer-sound', type: 'character-speak', targetId: 'farmer', data: { say: 'Shoo! Go away wolf!', character: 'farmer' } },
        { id: 'wolf-animate', type: 'tap-animate', targetId: 'wolf-running', data: { animation: 'animate-dance', duration: 800 } },
        { id: 'boy-sound', type: 'character-speak', targetId: 'boy-sorry', data: { say: 'I am sorry. I will always tell the truth!', character: 'boy' } },
