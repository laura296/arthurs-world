...
const storyData = {
  ...
  pages: [
      ...
      interactions: [
        {
          id: 'straw-count',
          type: 'tap-count',
          targetId: 'straw-bundle',
          data: { max: 5 },
        },
        {
          id: 'house-wiggle',
          type: 'tap-wiggle',
          targetId: 'straw-house',
          data: {},
        },
        {
          id: 'pig-straw-sound',
          type: 'tap-sound',
          targetId: 'pig-straw',
          data: { say: 'All done!', sfx: 'pig' },
        },
        {
          id: 'butterfly-animate',
          type: 'tap-animate',
          targetId: 'butterfly',
    ...
    // ── Page 3: Stick House ──
    {
      ...
      interactions: [
        ...
        },
        {
          ...
          type: 'tap-sound',
          targetId: 'pig-sticks',
          data: { say: 'Nearly done!', sfx: 'pig' },
        },
        {
          id: 'stick-house-swap',
          type: 'tap-swap',
          targetId: 'stick-house',
          data: { altContent: 'Building!' },
        },
        {
          id: 'bird-animate',
          type: 'tap-animate',
      ...
      interactions: [
        {
          ...
          type: 'drag-to-target',
          targetId: 'bricks',
          data: { dropZone: { x: 74, y: 50, radius: 40 }, onDrop: 'snap' },
        },
        {
          id: 'brick-house-grow',
          type: 'tap-grow',
          targetId: 'brick-house',
          data: {},
        },
        {
          id: 'pig-bricks-sound',
          type: 'tap-sound',
          targetId: 'pig-bricks',
          data: { say: 'Nice and strong!', sfx: 'pig' },
        },
        {
          id: 'flower-color',
          type: 'tap-color',
          targetId: 'flower',
          data: { colors: ['#FF6347', '#FFD700', '#FF69B4', '#9370DB'] },
        },
        {
          id: 'pig-sparkle',
          type: 'tap-sparkle',
    ...
    // ── Page 5: The Wolf Arrives ──
    {
      ...
      interactions: [
        ...
        },
        {
          id: 'eyes-reveal',
          type: 'tap-reveal',
          targetId: 'hidden-eyes',
          data: { content: 'The wolf is coming!' },
        },
      ],
    },
    ...
    // ── Page 7: Stick House Blown Down ──
    {
      ...
      interactions: [
        ...
        },
        {
          id: 'stick-house-hide',
          type: 'tap-hide',
          targetId: 'stick-house-blow',
          data: {},
        },
        {
          id: 'pig-run-1-animate',
          type: 'tap-animate',
          targetId: 'pig-run-1',
      ...
      interactions: [
        {
          id: 'pigs-safe-sound',
          type: 'tap-sound',
          targetId: 'pigs-inside-2',
          data: { say: "You can't get us!", sfx: 'pig' },
        },
        {
          id: 'wolf-outside-shake',
          type: 'tap-shake',
          targetId: 'wolf-outside',
          data: {},
        },
        {
          id: 'brick-house-safe-grow',
          type: 'tap-grow',
          targetId: 'brick-house-safe',
          data: {},
        },
        {
          id: 'pigs-inside-1-swap',
          type: 'tap-swap',
          targetId: 'pigs-inside-1',
          data: { altContent: 'Grrr!' },
        },
        {
    ...
    // ── Page 9: Wolf Can't Blow It Down ──
    {
      ...
      interactions: [
        ...
        },
        {
          ...
          type: 'tap-swap',
          targetId: 'wolf-tired',
          data: { altContent: 'Oh no!' },
        },
        {
          id: 'brick-house-strong-sparkle',
          type: 'tap-sparkle',
          targetId: 'brick-house-strong',
          data: {},
        },
        {
          id: 'dizzy-stars-spin',
    ...
    // ── Page 10: Happily Ever After ──
    {
      ...
      interactions: [
        {
          id: 'pig-dance-1-animate',
          type: 'tap-animate',
          targetId: 'pig-dance-1',
          data: { animation: 'animate-dance', duration: 1000 },
        },
        {
          id: 'pig-dance-2-animate',
          type: 'tap-animate',
          targetId: 'pig-dance-2',
          data: { animation: 'animate-dance', duration: 1000 },
        },
        {
          id: 'pig-dance-3-animate',
          type: 'tap-animate',
          targetId: 'pig-dance-3',
          data: { animation: 'animate-dance', duration: 1000 },
        },
        {
          id: 'house-final-sparkle',
          type: 'tap-sparkle',
          targetId: 'house-final',
          data: {},
        },
        {
          id: 'star-1-spin',
        ...
        },
        {
          ...
          type: 'tap-color',
          targetId: 'star-2',
          data: { colors: ['#A855F7', '#3B82F6', '#22C55E', '#EAB308', '#F97316', '#EF4444'] },
        },
        {
          id: 'pigs-hooray',
          type: 'tap-sound',
...
export default function ThreeLittlePigs() {
