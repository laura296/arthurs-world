  ...
  pages: [
    ...
    // ── Page 2: Boastful Kangaroo ──
    {
      ...
      elements: [
        ...
        { id: 'speech-bubble', x: 50, y: 14, hotspot: true, w: 120, h: 100, z: 2 },
    ...
    // ── Page 3: Asks Nqong ──
    {
      ...
      interactions: [
        ...
        { id: 'spider-reveal', type: 'tap-reveal', targetId: 'hidden-spider', data: { content: 'A spider!' } },
      ],
    },
    ...
    // ── Page 5: Desert Chase ──
    {
      ...
      elements: [
        ...
        { id: 'cactus-desert', x: 12, y: 52, hotspot: true, w: 120, h: 100, z: 1 },
    ...
    // ── Page 7: Mountain Chase ──
    {
      ...
      elements: [
        { id: 'jumping-kangaroo', x: 60, y: 32, hotspot: true, w: 120, h: 100, z: 3 },
    ...
    // ── Page 8: New Legs ──
    {
      ...
      elements: [
        { id: 'changed-kangaroo', x: 50, y: 40, hotspot: true, w: 120, h: 100, z: 3 },
    ...
    // ── Page 9: Bouncy Kangaroo ──
    {
      ...
      elements: [
        { id: 'bouncy-kangaroo', x: 50, y: 36, hotspot: true, w: 120, h: 100, z: 3 },
    ...
    // ── Page 10: The End ──
    {
      ...
      elements: [
        { id: 'happy-kangaroo', x: 50, y: 38, hotspot: true, w: 120, h: 100, z: 3 },
        { id: 'dingo-friend', x: 82, y: 52, hotspot: true, w: 120, h: 100, z: 2 },
        { id: 'hidden-lizard', x: 25, y: 66, hotspot: true, w: 120, h: 100, z: 1 },
      ],
      interactions: [
