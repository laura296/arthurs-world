...
const storyData = {
  ...
  audioDir: '/arthurs-world/audio/leopard-spots',
  pages: [
    // ── Page 1: The Sandy-Yellow Leopard ──
    {
      ...
      elements: [
        ...
        { id: 'desert-sand', x: 22, y: 62, hotspot: true, w: 120, h: 100, z: 1 },
        { id: 'golden-sparkle', x: 45, y: 18, hotspot: true, w: 120, h: 100, z: 2 },
        { id: 'hidden-mouse', x: 88, y: 66, hotspot: true, w: 120, h: 100, z: 1 },
      ],
      interactions: [
        {
          id: 'leopard-color',
    ...
    // ── Page 2: The Leopard and Ethiopian ──
    {
      ...
      elements: [
        ...
        { id: 'spear', x: 82, y: 32, hotspot: true, w: 120, h: 100, z: 2 },
        { id: 'savanna-tree', x: 14, y: 30, hotspot: true, w: 120, h: 100, z: 1 },
        { id: 'hidden-ant', x: 12, y: 68, hotspot: true, w: 120, h: 100, z: 1 },
      ],
      interactions: [
        {
          id: 'leopard-sound',
    ...
    // ── Page 3: Animals Run to the Forest ──
    {
      ...
      elements: [
        ...
        { id: 'dark-tree-1', x: 15, y: 28, hotspot: true, w: 120, h: 100, z: 2 },
        { id: 'dark-tree-2', x: 80, y: 30, hotspot: true, w: 120, h: 100, z: 2 },
        { id: 'shadow-patch', x: 45, y: 62, hotspot: true, w: 120, h: 100, z: 1 },
      ],
      interactions: [
        {
          id: 'giraffe-hide',
        ...
        },
        {
          id: 'tree1-shake',
          type: 'tap-shake',
          targetId: 'dark-tree-1',
          data: {},
        },
        {
          id: 'tree2-wiggle',
          type: 'tap-wiggle',
          targetId: 'dark-tree-2',
          data: {},
        },
        {
          id: 'shadow-sound',
    ...
    // ── Page 4: The Confused Leopard ──
    {
      ...
      elements: [
        ...
        { id: 'dark-forest', x: 78, y: 32, hotspot: true, w: 120, h: 100, z: 1 },
        { id: 'tumbleweed', x: 20, y: 60, hotspot: true, w: 120, h: 100, z: 1 },
        { id: 'hidden-beetle', x: 90, y: 68, hotspot: true, w: 120, h: 100, z: 1 },
      ],
      interactions: [
        {
    ...
    // ── Page 5: The Wise Baboon ──
    {
      ...
      elements: [
        ...
        { id: 'wise-star', x: 30, y: 14, hotspot: true, w: 120, h: 100, z: 2 },
        { id: 'forest-ahead', x: 85, y: 28, hotspot: true, w: 120, h: 100, z: 1 },
        { id: 'hidden-snail', x: 14, y: 66, hotspot: true, w: 120, h: 100, z: 1 },
      ],
      interactions: [
        {
          id: 'baboon-sound',
        ...
        },
        {
          ...
          type: 'tap-color',
          targetId: 'ethiopian-changing',
          data: { colors: ['#fbbf24', '#a16207', '#78350f', '#451a03', '#1c1917'] },
        },
        {
          id: 'star-sparkle',
          type: 'tap-sparkle',
    ...
    // ── Page 6: Now YOU Need Spots! ──
    {
      ...
      elements: [
        ...
        { id: 'speech-bubble', x: 30, y: 14, hotspot: true, w: 120, h: 100, z: 2 },
        { id: 'shadow-left', x: 14, y: 50, hotspot: true, w: 120, h: 100, z: 1 },
        { id: 'shadow-right', x: 88, y: 54, hotspot: true, w: 120, h: 100, z: 1 },
      ],
      interactions: [
        {
    ...
    // ── Page 8: WOW! Beautiful Spots! ──
    {
      ...
      elements: [
        ...
        { id: 'sparkle-right', x: 72, y: 22, hotspot: true, w: 120, h: 100, z: 2 },
        { id: 'wow-star', x: 50, y: 12, hotspot: true, w: 120, h: 100, z: 1 },
        { id: 'hidden-ladybird', x: 10, y: 64, hotspot: true, w: 120, h: 100, z: 1 },
      ],
      interactions: [
        {
    ...
    // ── Page 9: Sneaking Through Shadows ──
    {
      ...
      elements: [
        ...
        { id: 'tree-right', x: 80, y: 32, hotspot: true, w: 120, h: 100, z: 2 },
        { id: 'shadow-spots', x: 45, y: 62, hotspot: true, w: 120, h: 100, z: 1 },
        { id: 'hidden-frog', x: 88, y: 64, hotspot: true, w: 120, h: 100, z: 1 },
      ],
      interactions: [
        {
    ...
    // ── Page 10: The End! ──
    {
      ...
      elements: [
        ...
        { id: 'zebra-friend', x: 78, y: 38, hotspot: true, w: 120, h: 100, z: 2 },
        { id: 'hearts', x: 45, y: 14, hotspot: true, w: 120, h: 100, z: 2 },
        { id: 'hidden-butterfly', x: 92, y: 14, hotspot: true, w: 120, h: 100, z: 1 },
      ],
      interactions: [
        {
...
export default function LeopardSpots() {
