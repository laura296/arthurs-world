  ...
  pages: [
    // ── Page 1: Introduction ──
    {
      ...
      elements: [
        ...
        { id: 'fish-bg', x: 75, y: 55, hotspot: true, w: 80, h: 70, z: 1 },
        { id: 'bubbles', x: 35, y: 28, hotspot: true, w: 60, h: 60, z: 1 },
        { id: 'wave-right', x: 85, y: 22, hotspot: true, w: 80, h: 70, z: 1 },
      ],
      interactions: [
        {
          id: 'whale-grow',
    ...
    // ── Page 2: Gobble Gobble ──
    {
      ...
      elements: [
        ...
        { id: 'fish-2', x: 68, y: 50, hotspot: true, w: 90, h: 80, z: 2 },
        { id: 'fish-3', x: 80, y: 38, hotspot: true, w: 80, h: 70, z: 2 },
        { id: 'fish-4', x: 72, y: 25, hotspot: true, w: 80, h: 70, z: 2 },
        { id: 'chomp', x: 40, y: 55, hotspot: true, w: 80, h: 70, z: 1 },
      ],
      interactions: [
        {
    ...
    // ── Page 3: One Fish Left ──
    {
      ...
      elements: [
        ...
        { id: 'empty-water', x: 50, y: 70, hotspot: true, w: 80, h: 70, z: 1 },
        { id: 'hidden-starfish', x: 85, y: 68, hotspot: true, w: 50, h: 50, z: 1 },
      ],
      interactions: [
        {
          id: 'fish-idea-sound',
    ...
    // ── Page 4: The Clever Plan ──
    {
      ...
      elements: [
        ...
        { id: 'raft', x: 65, y: 38, hotspot: true, w: 110, h: 90, z: 1 },
        { id: 'hidden-crab', x: 15, y: 72, hotspot: true, w: 50, h: 50, z: 1 },
        { id: 'pointing', x: 42, y: 38, hotspot: true, w: 70, h: 60, z: 2 },
      ],
      interactions: [
        {
          id: 'fish-try-sound',
    ...
    // ── Page 5: Whale Swims ──
    {
      ...
      elements: [
        ...
        { id: 'wave-1', x: 15, y: 25, hotspot: true, w: 80, h: 70, z: 1 },
        { id: 'wave-2', x: 85, y: 20, hotspot: true, w: 80, h: 70, z: 1 },
      ],
      interactions: [
        {
    ...
    // ── Page 6: Swallowed Whole ──
    {
      ...
      elements: [
        ...
        { id: 'gulp-effect', x: 50, y: 60, hotspot: true, w: 80, h: 70, z: 1 },
        { id: 'surprised-fish', x: 82, y: 55, hotspot: true, w: 60, h: 60, z: 1 },
      ],
      interactions: [
        {
          id: 'mouth-grow',
    ...
    // ── Page 7: Building the Grating ──
    {
      ...
      elements: [
        ...
        { id: 'hammer', x: 55, y: 60, hotspot: true, w: 90, h: 80, z: 2 },
        { id: 'grating-target', x: 50, y: 35, hotspot: true, w: 80, h: 70, z: 0 },
      ],
      interactions: [
        {
          id: 'grating-drag',
    ...
    // ── Page 8: Stuck in His Throat ──
    {
      ...
      elements: [
        ...
        { id: 'star-1', x: 20, y: 25, hotspot: true, w: 70, h: 70, z: 1 },
        { id: 'star-2', x: 72, y: 22, hotspot: true, w: 70, h: 60, z: 1 },
        { id: 'dizzy', x: 60, y: 30, hotspot: true, w: 70, h: 60, z: 2 },
      ],
      interactions: [
        {
    ...
    // ── Page 9: Man Escapes ──
    {
      ...
      elements: [
        ...
        { id: 'sad-whale-end', x: 25, y: 48, hotspot: true, w: 150, h: 130, z: 2 },
        { id: 'escape-waves', x: 50, y: 65, hotspot: true, w: 80, h: 70, z: 1 },
      ],
      interactions: [
        {
    ...
    // ── Page 10: The End ──
    {
      ...
      elements: [
        ...
        { id: 'happy-crab', x: 18, y: 65, hotspot: true, w: 90, h: 80, z: 2 },
        { id: 'happy-octopus', x: 78, y: 60, hotspot: true, w: 90, h: 80, z: 2 },
        { id: 'happy-fish', x: 55, y: 58, hotspot: true, w: 80, h: 70, z: 2 },
        { id: 'hidden-pearl', x: 88, y: 72, hotspot: true, w: 50, h: 50, z: 1 },
      ],
      interactions: [
        {
          id: 'whale-sparkle',
