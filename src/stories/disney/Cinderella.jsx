  ...
  pages: [
    // ── Page 1: Introduction ──
    {
      ...
      elements: [
        ...
        { id: 'stepsister1', x: 20, y: 55, hotspot: true, w: 110, h: 110, z: 2 },
        { id: 'stepsister2', x: 80, y: 55, hotspot: true, w: 110, h: 110, z: 2 },
        { id: 'broom', x: 50, y: 75, hotspot: true, w: 80, h: 80, z: 1 },
    ...
    // ── Page 2: The Royal Invitation ──
    {
      ...
      elements: [
        ...
        { id: 'castle', x: 80, y: 25, hotspot: true, w: 130, h: 130, z: 1 },
        { id: 'trumpet', x: 20, y: 30, hotspot: true, w: 90, h: 90, z: 2 },
        { id: 'crown', x: 75, y: 15, hotspot: true, w: 70, h: 70, z: 2 },
      ],
      interactions: [
    ...
    // ── Page 3: Cinderella is Sad ──
    {
      ...
      elements: [
        ...
        { id: 'window', x: 75, y: 25, hotspot: true, w: 100, h: 100, z: 1 },
        { id: 'tear', x: 55, y: 65, hotspot: true, w: 60, h: 60, z: 2 },
    ...
    // ── Page 4: The Fairy Godmother ──
    {
      ...
      elements: [
        ...
        { id: 'wand', x: 60, y: 30, hotspot: true, w: 80, h: 80, z: 3 },
        { id: 'sparkle1', x: 30, y: 25, hotspot: true, w: 70, h: 70, z: 2 },
        { id: 'sparkle2', x: 70, y: 20, hotspot: true, w: 70, h: 70, z: 2 },
        { id: 'cinderella-amazed', x: 30, y: 60, hotspot: true, w: 120, h: 120, z: 2 },
      ],
      interactions: [
    ...
    // ── Page 5: The Pumpkin Coach ──
    {
      ...
      elements: [
        ...
        { id: 'coach', x: 65, y: 45, hotspot: true, w: 150, h: 150, z: 2 },
        { id: 'mice', x: 50, y: 72, hotspot: true, w: 100, h: 100, z: 2 },
        { id: 'magic-trail', x: 45, y: 35, hotspot: true, w: 90, h: 90, z: 1 },
      ],
      interactions: [
        { id: 'pumpkin-grow', type: 'tap-grow', targetId: 'pumpkin', data: {} },
        { id: 'pumpkin-sparkle', type: 'tap-sparkle', targetId: 'pumpkin', data: {} },
        { id: 'coach-sparkle', type: 'tap-sparkle', targetId: 'coach', data: {} },
        { id: 'mice-sound', type: 'tap-sound', targetId: 'mice', data: { say: 'Squeak squeak!', sfx: 'mouse' } },
        { id: 'magic-trail-spin', type: 'tap-spin', targetId: 'magic-trail', data: {} },
      ],
    },
    ...
    // ── Page 6: The Glass Slipper ──
    {
      ...
      elements: [
        ...
        { id: 'glass-slipper', x: 50, y: 75, hotspot: true, w: 90, h: 90, z: 2 },
        { id: 'tiara', x: 50, y: 20, hotspot: true, w: 80, h: 80, z: 2 },
        { id: 'sparkle-trail', x: 25, y: 35, hotspot: true, w: 70, h: 70, z: 1 },
      ],
      interactions: [
        { id: 'dress-sparkle', type: 'tap-sparkle', targetId: 'cinderella-dress', data: {} },
        { id: 'dress-spin', type: 'tap-spin', targetId: 'cinderella-dress', data: {} },
        { id: 'slipper-sparkle', type: 'tap-sparkle', targetId: 'glass-slipper', data: {} },
        { id: 'tiara-color', type: 'tap-color', targetId: 'tiara', data: { colors: ['#fbbf24', '#60a5fa', '#f0abfc', '#34d399'] } },
        { id: 'sparkle-trail-spin', type: 'tap-spin', targetId: 'sparkle-trail', data: {} },
      ],
    },
    ...
    // ── Page 7: The Ball ──
    {
      ...
      elements: [
        ...
        { id: 'cinderella-dance', x: 65, y: 48, hotspot: true, w: 130, h: 130, z: 2 },
        { id: 'chandelier', x: 50, y: 12, hotspot: true, w: 100, h: 100, z: 1 },
      ...
      interactions: [
        ...
        { id: 'music-note-spin', type: 'tap-spin', targetId: 'music-note', data: {} },
      ],
    },
    ...
    // ── Page 8: Midnight ──
    {
      ...
      elements: [
        ...
        { id: 'cinderella-run', x: 30, y: 55, hotspot: true, w: 120, h: 120, z: 2 },
        { id: 'slipper-stairs', x: 60, y: 70, hotspot: true, w: 80, h: 80, z: 2 },
        { id: 'stairs', x: 65, y: 50, hotspot: true, w: 130, h: 130, z: 1 },
      ],
      interactions: [
    ...
    // ── Page 9: The Prince Searches ──
    {
      ...
      elements: [
        ...
        { id: 'cinderella-fit', x: 60, y: 50, hotspot: true, w: 130, h: 130, z: 2 },
        { id: 'slipper-fit', x: 55, y: 72, hotspot: true, w: 80, h: 80, z: 3 },
    ...
    // ── Page 10: Happily Ever After ──
    {
      ...
      elements: [
        ...
        { id: 'castle-final', x: 50, y: 15, hotspot: true, w: 140, h: 140, z: 1 },
        { id: 'star-left', x: 15, y: 20, hotspot: true, w: 80, h: 80, z: 1 },
        { id: 'star-right', x: 85, y: 20, hotspot: true, w: 80, h: 80, z: 1 },
        { id: 'heart-final', x: 50, y: 72, hotspot: true, w: 100, h: 100, z: 1 },
      ],
      interactions: [
        { id: 'couple-dance', type: 'tap-animate', targetId: 'couple', data: { animation: 'animate-dance', duration: 1500 } },
        { id: 'couple-sparkle', type: 'tap-sparkle', targetId: 'couple', data: {} },
        { id: 'castle-final-sparkle', type: 'tap-sparkle', targetId: 'castle-final', data: {} },
        { id: 'star-left-spin', type: 'tap-spin', targetId: 'star-left', data: {} },
        { id: 'star-right-color', type: 'tap-color', targetId: 'star-right', data: { colors: ['#fbbf24', '#f0abfc', '#60a5fa', '#34d399'] } },
        { id: 'heart-final-sound', type: 'tap-sound', targetId: 'heart-final', data: { say: 'The End! Happily ever after!' } },
      ],
    },
  ],
};
