...
const storyData = {
  ...
  pages: [
    ...
    {
      bg: 'from-amber-600 to-emerald-700',
      ...
      elements: [
        { id: 'baby-elephant', x: 50, y: 55, hotspot: true, w: 120, h: 100, z: 3 },
        { id: 'mama-elephant', x: 22, y: 50, hotspot: true, w: 120, h: 100, z: 2 },
        { id: 'butterfly', x: 65, y: 30, hotspot: true, w: 120, h: 100, z: 4 },
      ],
      interactions: [
        ...
        { id: 'i3', targetId: 'butterfly', type: 'flap-reveal', data: { revealContent: 'Surprise!' } },
      ],
    },

    // ── Page 2: The elephant asks EVERYONE ──
    {
      bg: 'from-green-700 to-amber-600',
      ...
      elements: [
        { id: 'baby-q', x: 50, y: 52, hotspot: true, w: 120, h: 100, z: 4 },
        { id: 'hippo', x: 20, y: 50, hotspot: true, w: 120, h: 100, z: 3 },
        { id: 'bird', x: 78, y: 25, hotspot: true, w: 120, h: 100, z: 2 },
        { id: 'bush', x: 82, y: 55, hotspot: true, w: 120, h: 100, z: 2 },
      ],
      interactions: [
        ...
        { id: 'i4', targetId: 'bush', type: 'flap-reveal', data: { revealContent: 'A snake!' } },
      ],
    },

    // ── Page 3: Setting off — departure at waterhole ──
    {
      bg: 'from-sky-500 to-amber-500',
      ...
      elements: [
        { id: 'baby-go', x: 60, y: 52, hotspot: true, w: 120, h: 100, z: 4 },
        { id: 'hippo-wave', x: 25, y: 48, hotspot: true, w: 120, h: 100, z: 3 },
        { id: 'footprints', x: 75, y: 68, hotspot: true, w: 120, h: 100, z: 1 },
      ],
      interactions: [
    ...
    // ── Page 4: Arriving at the river — crocodile peek-a-boo ──
    {
      ...
      elements: [
        { id: 'baby-river', x: 25, y: 48, hotspot: true, w: 120, h: 100, z: 4 },
        { id: 'croc-eyes', x: 55, y: 52, hotspot: true, w: 120, h: 100, z: 3 },
        { id: 'reeds', x: 80, y: 45, hotspot: true, w: 120, h: 100, z: 2 },
        { id: 'dragonfly', x: 40, y: 28, hotspot: true, w: 120, h: 100, z: 1 },
      ],
      interactions: [
        ...
        { id: 'i3', targetId: 'reeds', type: 'flap-reveal', data: { revealContent: 'A frog!' } },
    ...
    // ── Page 5: The crocodile appears — tense! ──
    {
      ...
      elements: [
        { id: 'baby-scared', x: 25, y: 50, hotspot: true, w: 120, h: 100, z: 4 },
        { id: 'croc-log', x: 58, y: 55, hotspot: true, w: 120, h: 100, z: 3 },
        { id: 'water-dark', x: 50, y: 70, hotspot: true, w: 120, h: 100, z: 1 },
      ],
      interactions: [
    ...
    {
      bg: 'from-red-600 to-emerald-800',
      image: '/arthurs-world/images/elephant-child/page-6.png',
      text: 'SNAP! The Crocodile caught the elephant by his little nose!',
      elements: [
        { id: 'baby-snap', x: 30, y: 48, hotspot: true, w: 120, h: 100, z: 4 },
        { id: 'croc-bite', x: 55, y: 50, hotspot: true, w: 120, h: 100, z: 5 },
        { id: 'splash', x: 50, y: 68, hotspot: true, w: 120, h: 100, z: 2 },
        { id: 'snap-fx', x: 44, y: 38, hotspot: true, w: 120, h: 100, z: 6 },
      ],
      interactions: [
    ...
    // ── Page 7: Tug-of-war — the nose STRETCHES! ──
    {
      ...
      elements: [
        { id: 'baby-pull', x: 22, y: 46, hotspot: true, w: 120, h: 100, z: 4 },
        { id: 'croc-pull', x: 62, y: 50, hotspot: true, w: 120, h: 100, z: 5 },
        { id: 'stretch-1', x: 38, y: 52, hotspot: true, w: 120, h: 100, z: 3 },
        { id: 'pull-count', x: 50, y: 28, hotspot: true, w: 120, h: 100, z: 6 },
      ],
      interactions: [
    ...
    // ── Page 8: POP! Relief — the croc lets go ──
    {
      ...
      elements: [
        { id: 'baby-free', x: 50, y: 48, hotspot: true, w: 120, h: 100, z: 4 },
        { id: 'croc-flee', x: 82, y: 60, hotspot: true, w: 120, h: 100, z: 2 },
        { id: 'pop-fx', x: 50, y: 28, hotspot: true, w: 120, h: 100, z: 5 },
      ],
      interactions: [
    ...
    {
      bg: 'from-green-600 to-amber-500',
      ...
      elements: [
        { id: 'baby-play', x: 45, y: 48, hotspot: true, w: 120, h: 100, z: 4 },
        { id: 'fruit-1', x: 28, y: 32, hotspot: true, w: 120, h: 100, z: 3 },
        { id: 'fruit-2', x: 68, y: 35, hotspot: true, w: 120, h: 100, z: 3 },
        { id: 'fruit-3', x: 75, y: 28, hotspot: true, w: 120, h: 100, z: 3 },
        { id: 'water-spray', x: 20, y: 58, hotspot: true, w: 120, h: 100, z: 2 },
      ],
      interactions: [
    ...
    // ── Page 10: Celebration — all elephants want long trunks! ──
    {
      ...
      elements: [
        { id: 'baby-proud', x: 50, y: 50, hotspot: true, w: 120, h: 100, z: 4 },
        { id: 'mama-proud', x: 22, y: 46, hotspot: true, w: 120, h: 100, z: 3 },
        { id: 'star-1', x: 35, y: 22, hotspot: true, w: 120, h: 100, z: 2 },
        { id: 'star-2', x: 65, y: 18, hotspot: true, w: 120, h: 100, z: 2 },
        { id: 'the-end', x: 50, y: 78, hotspot: true, w: 120, h: 100, z: 5 },
      ],
      interactions: [
