  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        'wiggle-gentle': 'wiggleGentle 0.6s ease-in-out',
        'wiggle-excited': 'wiggleExcited 0.6s cubic-bezier(0.34, 1.56, 0.64, 1)',
        ...
        'spin360': 'spin360 0.6s cubic-bezier(0.25, 0.46, 0.45, 0.94)',
      ...
      keyframes: {
        ...
        shake: {
          ...
          '12%': { transform: 'translate(-6px, -2px) rotate(-3deg)' },
          '25%': { transform: 'translate(5px, 3px) rotate(2deg)' },
          '37%': { transform: 'translate(-4px, 1px) rotate(-2deg)' },
          '50%': { transform: 'translate(3px, -2px) rotate(1.5deg)' },
          '62%': { transform: 'translate(-2px, 1px) rotate(-1deg)' },
          '75%': { transform: 'translate(1px, -1px) rotate(0.5deg)' },
          '100%': { transform: 'translate(0, 0) rotate(0deg)' },
        },
        spin360: {
          '0%': { transform: 'rotate(0deg) scale(1)' },
          '30%': { transform: 'rotate(130deg) scale(1.08)' },
          '60%': { transform: 'rotate(280deg) scale(1.04)' },
        ...
        hopBounce: {
          ...
          '8%': { transform: 'translateY(4px) scaleX(1.12) scaleY(0.88)' },
          '18%': { transform: 'translateY(-40px) scaleX(0.92) scaleY(1.1)' },
          '28%': { transform: 'translateY(0) scaleX(1.08) scaleY(0.92)' },
          '36%': { transform: 'translateY(2px) scaleX(1.06) scaleY(0.94)' },
          '46%': { transform: 'translateY(-22px) scaleX(0.95) scaleY(1.06)' },
          '56%': { transform: 'translateY(0) scaleX(1.04) scaleY(0.96)' },
          '66%': { transform: 'translateY(1px) scaleX(1.03) scaleY(0.97)' },
          '76%': { transform: 'translateY(-8px) scaleX(0.98) scaleY(1.02)' },
          '86%': { transform: 'translateY(0) scaleX(1.01) scaleY(0.99)' },
